...
if(!empty($_SESSION['rm_tokenkey'] and $num_risk>=$_SESSION['rm_level_alert'])){  
include_once '../function/LineNotify.php';  
include_once '../template/plugins/funcDateThai.php';
$token = $_SESSION['rm_tokenkey'];
$text = "\nความเสี่ยงที่ ".$add_risk." :\nเกิดเหตุวันที่ ".DateThai1($take_date)." เวลา ".$take_time." น.\nระดับความรุนแรง ".$level_risk['level_risk']."\nรายละเอียด : ".$take_detail;
